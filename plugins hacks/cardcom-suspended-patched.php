...
//            $this->cvvFreeTerminal = $this->settings['cvvFreeTerminal'];
        ...
        public static function CreateinvoiceForPayPal($order_id){
            ...
            if ( strpos($order->get_payment_method(), 'paypal') !== false  && self::$IsActivateInvoiceForPaypal == '1') {
                //Paypal Case
                ...
                wc_add_order_item_meta((int)$order_id, 'InvoiceNumber', 0 );
                wc_add_order_item_meta((int)$order_id, 'InvoiceType', 0 );
        ...
        function init_form_fields() {
            ...
            $this->form_fields = array(
                ...
                'operation' => array(
                    //'title' => __( 'Operation', 'woothemes' ), --Orig title
                    ...
                    'type' => 'select',
                    'options'=>array('1'=>'Charge Only','2'=>'Charge and save TOKEN','4'=>'Suspended Deal'),
                ...
                'InvoiceVATFREE' => array(
                    ...
                    'type' => 'select',
                    'options'=>array('1'=>'Invoice VAT free','2'=>'Invoice will include Vat', '3'=>'Invoice include Tax per product'),
...
//            error_log($string);
            ...
            try {
                ...
                //$this->operationToPerform = $this->operation; ** disable for sespended deal hack **
...
//			}
            ...
            $args = array('body'=>$urlencoded,
                ...
                'headers' => array(),
                'cookies' => array());
            $response = wp_remote_post('https://secure.cardcom.solutions/BillGoldLowProfile.aspx',$args);
            if (is_wp_error($response)) {
                $error = $response->get_error_message();
                $this->HandleError('999',$error, $urlencoded);
                return;
            }
        ...
        function IsLowProfileCodeDealOneOK($lpc,$terminal,$username,$orderid)
        {
            ...
            $args = array('body'=>$urlencoded,
                ...
                'headers' => array(),
                'cookies' => array());
            $response = wp_remote_post('https://secure.cardcom.solutions/Interface/BillGoldGetLowProfileIndicator.aspx',$args);
            if (is_wp_error($response)) {
                $error = $response->get_error_message();
               $this->HandleError('999',$error, $urlencoded);
                return '1';
            ...
            if ($returnvalue =='0'){
                ...
                try {
                    if($responseArray['Operation'] == '2' && $responseArray['TokenResponse'] == '0'){
        ...
        function charge_token($cc_token, $order_id ,$cvv =''){
            ...
            $args = array('body'=>$urlencoded,
                ...
                'headers' => array(),
                'cookies' => array());
            $response = wp_remote_post('https://secure.cardcom.solutions/interface/ChargeToken.aspx',$args);
            $body = wp_remote_retrieve_body( $response );
            $responseArray =  array();
            $returnvalue = '1';
            parse_str($body,$responseArray);
...
/// Debug to console
   //  debug_to_console('hello cardcom');
